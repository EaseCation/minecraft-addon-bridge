...
/* {@code minecraft:nether<i>cave</i>carver<i>feature} carves a cave through the Nether in the current chunk, and in every chunk around the current chunk in an 8 radial pattern.This feature will also only work when placed specifically in the pass {@code pregeneration</i>pass}. */
@JsonIgnoreProperties(ignoreUnknown = true)
public record NetherCaveCarverFeature(
    @JsonProperty("description") Description description,
    /* Reference to the block to fill the cave with. */
    @JsonProperty("fill_with") @Nullable BlockReference fillWith,
