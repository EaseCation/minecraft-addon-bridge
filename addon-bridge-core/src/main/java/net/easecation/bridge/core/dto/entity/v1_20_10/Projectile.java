        ...
        public record OnHit(
            ...
            @JsonProperty("thrown_potion_effect") @Nullable net.easecation.bridge.core.dto.EmptyObject thrownPotionEffect
                ...
                public record MobEffect(
                    ...
                    @JsonProperty("durationeasy") @Nullable Integer durationeasy,
                    /* The effect's duration on hard mode. */
                    @JsonProperty("durationhard") @Nullable Integer durationhard,
                    /* The effect's duration on normal mode. */
                    @JsonProperty("durationnormal") @Nullable Integer durationnormal,
                ...
                public record SpawnAoeCloud(
                    ...
                    @JsonProperty("particle") @Nullable Integer particle,
