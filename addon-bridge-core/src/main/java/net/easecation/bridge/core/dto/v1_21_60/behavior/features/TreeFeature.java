...
public record TreeFeature(
    ...
    @JsonProperty("may_grow_on") @Nullable List<BlockReference> mayGrowOn,
    ...
    @JsonProperty("may_grow_through") @Nullable List<BlockReference> mayGrowThrough,
    ...
    @JsonProperty("mangrove_roots") @Nullable MangroveRoots mangroveRoots
        ...
        public record BaseCluster(
            ...
            @JsonProperty("may_replace") List<BlockReference> mayReplace,
        ...
        public record AcaciaTrunk(
            ...
            @JsonProperty("branches") @Nullable Branches branches
                ...
                public record TrunkLean(
                    ...
                    @JsonProperty("lean_height") @Nullable Range_a_B_ leanHeight,
                    /* Number of steps taken in X/Z direction while creating a diagonal branch. */
                    @JsonProperty("lean_steps") @Nullable Range_a_B_ leanSteps,
                    /* Length for the diagonal branch in the Y axis. */
                    @JsonProperty("lean_length") @Nullable Range_a_B_ leanLength
                ) {
                }
                ...
                public record Branches(
                    ...
                    @JsonProperty("branch_length") @Nullable Range_a_B_ branchLength,
                    /* Starting Y position for the branch. */
                    @JsonProperty("branch_position") @Nullable Range_a_B_ branchPosition,
        ...
        public record CherryTrunk(
            ...
            @JsonProperty("branches") @Nullable Branches branches
                ...
                public record Branches(
                    ...
                    @JsonProperty("branch_horizontal_length") @Nullable Range_a_B_ branchHorizontalLength,
                    /* Branch starting position relative to the top of the tree */
                    @JsonProperty("branch_start_offset_from_top") @Nullable Range_a_B_ branchStartOffsetFromTop,
                    /* Branch end position relative to the top of the tree */
                    @JsonProperty("branch_end_offset_from_top") @Nullable Range_a_B_ branchEndOffsetFromTop,
                    /* Probability of creating a branch. */
                    @JsonProperty("branch_chance") @Nullable ChanceInformation branchChance,
                    @JsonProperty("branch_canopy") @Nullable BranchCanopy branchCanopy
                ) {
        ...
        public record MangroveTrunk(
            ...
            @JsonProperty("trunk_decoration") @Nullable Decoration trunkDecoration
                ...
                public record Branches(
                    ...
                    @JsonProperty("branch_steps") @Nullable Range_a_B_ branchSteps,
                    /* Probability of creating a branch. */
                    @JsonProperty("branch_chance") @Nullable ChanceInformation branchChance
                ) {
                }
        ...
        public record MegaTrunk(
            ...
            @JsonProperty("branches") @Nullable Branches branches
                ...
                public record Branches(
                    ...
                    @JsonProperty("branch_interval") @Nullable Range_a_B_ branchInterval,
        ...
        public record Trunk(
            ...
            @JsonProperty("trunk_height") @Nullable Range_a_B_ trunkHeight,
        ...
        public record Canopy(
            ...
            @JsonProperty("canopy_decoration") @Nullable CanopyDecoration canopyDecoration
                ...
                public record CanopyDecoration(
                    ...
                    @JsonProperty("decoration_block") @Nullable BlockReference decorationBlock,
        ...
        public record MangroveCanopy(
            ...
            @JsonProperty("hanging_block") @Nullable BlockReference hangingBlock,
        ...
        public record MangroveRoots(
            ...
            @JsonProperty("root_block") @Nullable BlockReference rootBlock,
            ...
            @JsonProperty("above_root") @Nullable AboveRoot aboveRoot
                ...
                public record AboveRoot(
                    ...
                    @JsonProperty("above_root_block") @Nullable BlockReference aboveRootBlock,
                    /* The block used for muddy roots. */
                    @JsonProperty("muddy_root_block") @Nullable BlockReference muddyRootBlock,
                    /* The block used to determine if a muddy root should be placed. */
                    @JsonProperty("mud_block") @Nullable BlockReference mudBlock,
                    /* Root offset from the trunk */
                    @JsonProperty("y_offset") @Nullable Range_a_B_ yOffset,
                    /* List of blocks that a root can grow through. */
                    @JsonProperty("roots_may_grow_through") @Nullable List<BlockReference> rootsMayGrowThrough,
