...
public record LookedAt(
    /* Defines, in degrees, the width of the field of view for entities looking at the owner entity. If 'scale<i>fov</i>by_distance' is set to true, this value corresponds to the field of view at a distance of one block between the entities. */
    ...
    @JsonProperty("look_at_locations") @Nullable List<Object> lookAtLocations,
    ...
    @JsonProperty("looked_at_cooldown") @Nullable Range_a_B_ lookedAtCooldown,
    ...
    @JsonProperty("min_looked_at_duration") @Nullable Double minLookedAtDuration,
    /*
 ...
 * - "once</i>and<i>keep</i>scanning", the first detected looking entity is set as target. Scanning and event emission continues.
 */
