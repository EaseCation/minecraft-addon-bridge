...
/* {@code minecraft:cave<i>carver</i>feature} carves a cave through the world in the current chunk, and in every chunk around the current chunk in an 8 radial pattern. This feature will also only work when placed specifically in the pass {@code pregeneration_pass}. */
@JsonIgnoreProperties(ignoreUnknown = true)
public record CaveCarverFeature(
