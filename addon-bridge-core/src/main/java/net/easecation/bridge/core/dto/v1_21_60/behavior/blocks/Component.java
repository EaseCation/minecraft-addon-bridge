...
public record Component(
    ...
    @JsonProperty("minecraft:destruction_particles") @Nullable DestructionParticles minecraft_destructionParticles,
    ...
    @JsonProperty("minecraft:friction") @Nullable Friction minecraft_friction,
    ...
    @JsonProperty("minecraft:light_dampening") @Nullable LightDampening minecraft_lightDampening,
    @JsonProperty("minecraft:light_emission") @Nullable LightEmission minecraft_lightEmission,
    @JsonProperty("minecraft:liquid_detection") @Nullable LiquidDetection minecraft_liquidDetection,
    @JsonProperty("minecraft:loot") @Nullable Loot minecraft_loot,
