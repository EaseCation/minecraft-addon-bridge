...
public record StompAttack(
    ...
    @JsonProperty("no_damage_range_multiplier") @Nullable Double noDamageRangeMultiplier,
    ...
    @JsonProperty("stomp_range_multiplier") @Nullable Double stompRangeMultiplier,
    /* Unused. No effect on "minecraft:behavior.melee_attack". */
