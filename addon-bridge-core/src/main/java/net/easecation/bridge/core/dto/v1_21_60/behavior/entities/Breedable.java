...
public record Breedable(
    ...
    @JsonProperty("property_inheritance") @Nullable List<Map<String, Object>> propertyInheritance,
    ...
    @JsonProperty("combine_parent_colors") @Nullable Boolean combineParentColors,
