...
public record CircleAroundAnchor(
    ...
    @JsonProperty("height_above_target_range") @Nullable Range_a_B_ heightAboveTargetRange,
    /* The range of height in blocks offset the mob can have from it's anchor point. */
    @JsonProperty("height_offset_range") @Nullable Range_a_B_ heightOffsetRange,
