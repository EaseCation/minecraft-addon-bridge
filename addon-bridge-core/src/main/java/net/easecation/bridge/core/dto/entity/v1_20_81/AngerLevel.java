...
public record AngerLevel(
    ...
    @JsonProperty("default_annoyingness") @Nullable Double defaultAnnoyingness,
    /* The default amount of annoyingness for projectile nuisance. Specifies how much to raise anger level on each provocation */
    @JsonProperty("default_projectile_annoyingness") @Nullable Double defaultProjectileAnnoyingness,
    ...
    @JsonProperty("on_increase_sounds") @Nullable List<Object> onIncreaseSounds,
