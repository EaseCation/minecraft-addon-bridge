...
public record EhfWeightedEventBase(
    ...
    @JsonProperty("randomize") @Nullable List<EhfWeightedEventBase> randomize,
    /* A series of filters and components to be added. */
    @JsonProperty("sequence") @Nullable List<EhfEventBase> sequence,
    /* UNDOCUMENTED */
