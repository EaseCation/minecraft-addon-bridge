...
public record BjdInteractionSpec(
    ...
    /* Vibration to emit when the interaction occurs. Admitted values are none (no vibration emitted), shear, entity<i>die, entity</i>act, entity_interact. */
    ...
    @JsonProperty("drop_item_slot") @Nullable String dropItemSlot,
    /* Will offset the item drop position this amount in the y direction. Requires "drop<i>item</i>slot" to be specified. */
    @JsonProperty("drop_item_y_offset") @Nullable Double dropItemYOffset,
    /* The entity's equipment slot to equip the item to, if any, upon successful interaction. */
    @JsonProperty("equip_item_slot") @Nullable String equipItemSlot,
    /* Allows to repair one of the entity's items. */
    @JsonProperty("repair_entity_item") @Nullable RepairEntityItem repairEntityItem
) {
        ...
        /* Allows to repair one of the entity's items. */
        @JsonIgnoreProperties(ignoreUnknown = true)
        public record RepairEntityItem(
            /* How much of the item durability should be restored upon interaction. */
            @JsonProperty("amount") @Nullable Integer amount,
