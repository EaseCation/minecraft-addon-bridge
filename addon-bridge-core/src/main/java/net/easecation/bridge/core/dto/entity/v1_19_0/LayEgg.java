...
public record LayEgg(
    ...
    @JsonProperty("egg_type") @Nullable String eggType,
    ...
    @JsonProperty("target_blocks") @Nullable List<Object> targetBlocks,
    /* [EXPERIMENTAL] Types of materials that can exist above the target block. Valid types are Air, Water, and Lava. */
    @JsonProperty("target_materials_above_block") @Nullable List<Object> targetMaterialsAboveBlock,
