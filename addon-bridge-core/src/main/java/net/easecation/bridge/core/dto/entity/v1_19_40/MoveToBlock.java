...
public record MoveToBlock(
    ...
    @JsonProperty("on_stay_completed") @Nullable Object onStayCompleted,
    /* Event to run on block reached. */
    @JsonProperty("on_reach") @Nullable Object onReach,
    ...
    @JsonProperty("target_blocks") @Nullable List<EntityH> targetBlocks,
